  ...
  return (
    <div className="main-container">
      ...
      <div className="element">
        ...
        <input type="text" placeholder="0.0" className="address-input" disabled={props.fetching} value={shares} onChange={(e) => setShares(e.target.value)} />
      </div>

      <div className="element">
        <button className="btn btn-primary col-12 btn-lg" onClick={onWithdrawClick}>
          Withdraw
        </button>
      </div>
    </div>
