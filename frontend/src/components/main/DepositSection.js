  ...
  return (
    <div className="main-container">
      <div className="element">
        <label className="paste-label" style={{ lineHeight: "3em" }}>
          {tokenStore.symbolToken0}
        </label>
        <input
          type="text"
          placeholder="0.0"
        ...
        <label style={{ padding: "1em" }}>
          Your balance: <TokenBalance balance={tokenStore.balanceToken0} decimals={tokenStore.decimalsToken0} />
        </label>
      </div>

      <div className="element">
        <label className="paste-label" style={{ lineHeight: "3em" }}>
          {tokenStore.symbolToken1}
        </label>
        <input
          type="text"
          placeholder="0.0"
        ...
        <label style={{ padding: "1em" }}>
          Your balance: <TokenBalance balance={tokenStore.balanceToken1} decimals={tokenStore.decimalsToken1} />
        </label>
      </div>
